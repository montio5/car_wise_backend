...
class AppMessages(enum.Enum):
    MAX_CAR_ERROR = _(
        "You can not add more than {} cars in an account in free version".format(settings.ALLOWED_CAR_AMOUNT)
    )
    ...
    SHOULD_BE_POSETIVE_INTEGER = _(
        "The field {} Should be greater than 0!"
    )
